...
```
dependencies: [
    .package(url: "https://github.com/seontechnologies/seon-orchestration-sdk-ios-public", from: "1.0.4")
],
targets: [
    .target(
        name: "YourApp",
...
## 1.0.4
-   Updated Device Fingerprint SDK: iOS `SeonSDK` **5.7.1**

## 1.0.5
-   Updated Device Fingerprint SDK: iOS `SeonSDK` **5.8.2**, Android `androidsdk` **6.9.3**
